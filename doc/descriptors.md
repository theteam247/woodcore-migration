# Support for Output Descriptors in woodcoin Core

Since woodcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `LOG1...` for mainnet or `tLOG1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on woodcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing woodcoin Core wallets, a convenience function `combo` is
