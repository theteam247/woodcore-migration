...
1. Clone the woodcoin Core source code:
...
2.  Build woodcoin Core:
    ...
    Configure and build the headless woodcoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/woodcoin/src
        cp woodcoind /usr/local/bin/
        cp woodcoin-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/woodcoin"

    touch "/Users/${USER}/Library/Application Support/woodcoin/woodcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/woodcoin/woodcoin.conf"

The first time you run woodcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
