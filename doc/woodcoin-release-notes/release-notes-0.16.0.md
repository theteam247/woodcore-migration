woodcoin Core version 0.16.0 is now available from:
...
### BIP173 (Bech32) Address support ("LOG1..." addresses)
...
woodcoin Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile woodcoin Core is now 4.8. No effort will be
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("LOG1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
...
- #482 `5c8e26d` woodcoin: Basic changes for v0.16 release (thrasher-)
